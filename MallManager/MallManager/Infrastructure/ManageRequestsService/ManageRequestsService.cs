...
public class ManageRequestsService : IManageRequestsService
{
    ...
    public ManageRequestsService(ILogger<ManageRequestsService> logger,
        IRepositoryBase<LeaseApplication> leaseApplicationRepository,
        IRepositoryBase<MarketingCampaign> marketingCampaignRepository,
    ...
    public async Task LoadAspNetUserRequestsAsync(string userId)
    {
